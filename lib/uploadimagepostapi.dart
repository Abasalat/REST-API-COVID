...
class _UploadimagepostapiState extends State<Uploadimagepostapi> {
  File?
  image; // Store path of the image into file which we will uplad from gallery
  ...
  Future<void> uploadImage() async {
    ...
    request.fields['title'] = 'Image Post';
  ...
  Widget build(BuildContext context) {
    return ModalProgressHUD(
      ...
      child: Scaffold(
        appBar: AppBar(title: const Text('Upload Image Post Api')),
        body: Center(
          child: Column(
